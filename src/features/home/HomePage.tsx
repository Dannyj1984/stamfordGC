                ...
                <Paper elevation={2} style={margin} sx={{opacity:'0.8'}}>
                    ...
                    <div style={{display: 'flex', flexDirection:'column', alignItems:'center'}}>
                        ...
                        <Typography variant='h6' color='text.secondary' sx={{ paddingBottom:'10px'}}>
                            We are glad to welcome back members to Stamford golf club. We are also welcoming visitors and ask you to contact to professional's shop on 01457 832126 to book.
                        </Typography>

                        <Typography variant='h6' color='text.secondary' sx={{ paddingTop:'20px'}}>
                            For general enquiries please contact the Admin Manager on 01457 832126 email admin@stamfordgolfclub.co.uk
                        </Typography>
